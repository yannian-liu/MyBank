...
class YLActivityIndicatorAnimationBallPulse: YLActivityIndicatorAnimationDelegate {
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = YLActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
